/* =============================================================================
   Oxygen JS — Bodecatta Smash Burger Mex
   Cada bloque: --- SECCIÓN N ---
   Imágenes: https://bodecatta.com/wp-content/uploads/2026/08/
   ============================================================================= */

(function () {
  var root = document.getElementById("bd-smash-landing");
  if (!root) return;

  /* --- SECCIÓN 1: CONFIG / BOTONES --- */
  var cfg = window.BD_LANDING || {};
  var WA_MESSAGE = cfg.waMessage || "Hola! Quiero pedir el Combo Smash Burger Mex ($148). *Smash Burger + Papas* ¿Me ayudan?";
